...
gulp.task('fonts', function() {
    return gulp.src(['src/fonts/**/*','src/sass/font-awesome/webfonts/**/*'])
...
gulp.task('default', gulp.series('js', 'sass', 'browserSync', 'fonts', 'watch', function(done) {
    done();
}));

gulp.task('build', gulp.series('clean', 'js', 'sass', 'fonts', function(done) {
    done();
}));